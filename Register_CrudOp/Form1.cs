...
namespace Register_CrudOp
{
    public partial class Form1 : Form
    {
        ...
        SqlConnection con = new SqlConnection(@"Data Source=LAPTOP-CJ6SAAMH\SQLEXPRESS;Initial Catalog=UIPATH;Persist Security Info=True;User ID=sa;Password=ijas10");
